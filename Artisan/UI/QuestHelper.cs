        ...
        public unsafe override void Draw()
        {
            ...
            if (isOnEmoteQuest)
            {
                ...
                foreach (var quest in QuestManager.Instance()->DailyQuests)
                {
                    ...
                    {
                        if (ImGui.Button($@"Target {LuminaSheets.ENPCResidentSheet[data.NPCDataId].Singular.ToString()} and do {data.Emote}"))
                        {
                    ...
                    {
                        {
                            ...
                            {
                                if (ImGui.Button($@"Target {LuminaSheets.ENPCResidentSheet[npc1.NPCDataId].Singular.ToString()} and do {npc1.Emote}"))
                                {
                            ...
                            {
                                if (ImGui.Button($@"Target {LuminaSheets.ENPCResidentSheet[npc2.NPCDataId].Singular.ToString()} and do {npc2.Emote}"))
                                {
